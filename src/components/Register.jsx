...
const YourComponent = () => {
    ...
    const HandleSubmit = async (e) => {
        ...
        axios.post('http://localhost:7000/api/user/register', user)
            .then((res) => {
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='userName' onChange={(e) => HandleChange(e)} type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder='Enter your name'></input>
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='email' onChange={(e) => HandleChange(e)} type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your Email"></input>
                                    </div>
                                </div>
                            </div>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-6">
                                    ...
                                    <div className="flex">
                                        ...
                                        <input name='password' onChange={(e) => HandleChange(e)} type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Enter your password"></input>
                                    </div>
                                </div>
                            </div>
                            <div className=' mb-3'>
                                <span className=' font-semibold'>Already have an account? </span>
                                <Link to='/login'><button className=' text-blue-800'>Login</button></Link>
                            </div>
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
